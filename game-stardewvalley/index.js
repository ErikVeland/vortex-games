...
class StardewValley {
    ...
    readRegistryKeyAsync(hive, key, name) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const instPath = winapi_bindings_1.default.RegGetValue(hive, key, name);
                if (!instPath) {
